...
#ifndef INC_3D_WARP_OPENGL_CAMERA_H
#define INC_3D_WARP_OPENGL_CAMERA_H
...
public:
    ...
    Camera(const glm::vec3 &position, const glm::vec3 &front, const glm::vec3 &up, glm::mat3 rotation);
...
#endif //INC_3D_WARP_OPENGL_CAMERA_H
